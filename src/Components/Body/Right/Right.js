...
const right = (props) => {
    return (
        <div className="card-display span-3-of-4">
            ...
            <Route path="/ships/:id/upgrades/commander" render={(routeProps) => <Commander {...routeProps} cards={props.cards} shipInfo={props.shipInfo} upgrade={props.upgrade} points={props.points} upgradePoints={props.upgradePoints}/>}/>
