...
const right = (props) => {
    return (
        <div className="card-display span-3-of-4">
            ...
            <Route path="/ships/:id/upgrades/:type" render={(routeProps) => <UpgradePage {...routeProps}  shipInfo={props.shipInfo} upgrade={props.upgrade} points={props.points} upgradePoints={props.upgradePoints}/>}/>
        </div>
    )
};
